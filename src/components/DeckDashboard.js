        ...
        return (
            <Container>
                ...
                <Content>
                    ...
                    style={styles.card}>
                        <View 
                        style={styles.itemAlignment}>
                            <Text 
                            style={styles.title}>{title}</Text>
                            <Text 
                            style={styles.number} >{cards} Cards</Text>
                        </View>
                        <Button 
                        primary 
                        rounded 
                        style={styles.btn} 
                        onPress={() => this.props.navigation.navigate( "AddCard", { title, cards } )}><Text style={styles.txt}> Add Card </Text></Button>
                        <Button 
                        primary 
                        rounded 
                        style={styles.btn} 
                        onPress={() => this.props.navigation.navigate( "Quiz", { title } )}><Text style={styles.txt}> Start Quiz </Text></Button>
                        <Button 
                        primary 
                        rounded 
                        style={styles.btn} 
                        onPress={this.onDelete} ><Text style={styles.txt}> Delete </Text></Button>
